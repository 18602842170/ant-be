...
public class ToolUtil {
	 ...
	 * @return
	 */
	public static String getProPath(String filePath) {
		String t = Thread.currentThread().getContextClassLoader().getResource("").getPath();
		int num = t.indexOf(".metadata");
		String path = t.substring(1, num).replace('/', '\\') + "guns";
		// path = path.replace("/WEB-INF/classes/", "");
		// path = path.replace("/target/classes/", "");
		// path = path.replace("file:/", "");
		if (ToolUtil.isEmpty(filePath)) {
	...
	/**
	 * 数据库查询得到jsonb数据转换成正常格式
	 * 
	 * @param obj
	 * @return
	 */
	public static String conversToString(String strObj) {
		String str = strObj.substring(1, strObj.length() - 1).replace("\\", "");
		return str;
	}
	...
	public static Map<String, String> jsonbToMap(Object jsonb) {
		Map<String, String> per = null;
		JSONObject jsonobject = JSONObject.fromObject(jsonb);
		per = (Map<String, String>) JSONObject.toBean(jsonobject, Map.class);
		return per;
	}
	 ...
	 */
	public static <T> T copyProperties(Object _srcBean, T _dstBean)
	 ...
	 * @return
	 */
	public static Map<String, String> toJsonObject(String str) {
